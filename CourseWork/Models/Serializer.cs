            ...
            foreach (Scheme scheme in schemes)
            {
                ...
                foreach(Element element in elements)
                {
                    ...
                    if (element is TwoInputsGate two)
                    {
                        ...
                        if (two is EncoderGate) elem.Type = "EncoderGate";
            ...
            foreach (Scheme scheme in schemes)
            {
                ...
                foreach (Element element in elements)
                {
                    ...
                    if (element is SerializebleTwoInputElements two)
                    {
                        ...
                        if (two.Type == "EncoderGate")
                        {
                            new_elements.Add(new EncoderGate { ID = two.ID, FocusOnElement = two.FocusOnElement, Input1 = two.Input1, Input2 = two.Input2, IsConnectedInput1 = two.IsConnectedInput1, IsConnectedInput2 = two.IsConnectedInput2, StartPoint = Point.Parse(two.StartPoint) });
                            continue;
                        }
                    }
                }
